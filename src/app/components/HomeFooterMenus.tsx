      ...
      <Wrapper>
        <div className="flex flex-col md:grid md:grid-cols-4 gap-16 ">
          ...
          <div>
            ...
            <ul>
              <li className="font-normal text-base leading-[22px] text-[#666] mt-[25px]">About</li>
              <li className="font-normal text-base leading-[22px] text-[#666] mt-[15px]">Terms of Use</li>
              <li className="font-normal text-base leading-[22px] text-[#666] mt-[15px]">Privacy Policy</li>
              <li className="font-normal text-base leading-[22px] text-[#666] mt-[15px]">How it Works</li>
              <li className="font-normal text-base leading-[22px] text-[#666] mt-[15px]">Contact Us</li>
            </ul>
          </div>
          {/* THIRD COLUMN */}
          <div>
            ...
            <ul>
              ...
              <li className="font-normal text-base leading-[22px] text-[#666] mt-[15px]">24h Service</li>
              <li className="font-normal text-base leading-[22px] text-[#666] mt-[15px]">Quick Chat</li>
            </ul>
          </div>
          {/* FOURTH COLUMN */}
          <div>
            ...
            <ul>
              ...
              <li className="font-normal text-base leading-[22px] text-[#666] mt-[15px]">Support 24h</li>
            </ul>
          </div>
        </div>
      </Wrapper>
...
export default HomeFooterMenus;
